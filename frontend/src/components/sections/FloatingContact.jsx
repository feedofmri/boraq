            ...
            {showButton && (
                ...
                >
                    ...
                    <AnimatePresence>
                        {isOpen && (
                            <motion.div
                                ...
                                className="mb-4 glass-panel-heavy rounded-2xl p-4 shadow-2xl min-w-[280px] pointer-events-auto border-boraq-teal-steel/20"
                            >
                                <div className="flex items-center gap-3 mb-4 pb-4 border-b border-black/10 dark:border-white/10">
                                    ...
                                    <div>
                                        <div className="font-semibold text-sm text-boraq-black dark:text-boraq-white">Sarah from Boraq</div>
                                        <div className="text-xs text-boraq-black/60 dark:text-boraq-white/60">Typically replies in 5 mins</div>
                                    </div>
                                </div>
                    ...
                    <button
                        ...
                        className="w-14 h-14 rounded-full bg-boraq-black text-boraq-white dark:bg-boraq-white dark:text-boraq-black shadow-xl flex items-center justify-center pointer-events-auto hover:rotate-12 active:scale-95 transition-all outline-none focus:ring-4 focus:ring-boraq-teal-steel/30"
                    >
