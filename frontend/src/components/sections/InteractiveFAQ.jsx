...
export default function InteractiveFAQ() {
    ...
    const allRead = readItems.size >= (faqs?.length || 0);
    ...
    if (loading || !faqs?.length) {
        return <section className="max-w-7xl mx-auto px-6 py-24"><p className="text-center text-boraq-gray-mid">Loading FAQs...</p></section>;
    }
